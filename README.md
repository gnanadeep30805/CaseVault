...
Digitize and centralize sensitive legal and investigation records.

Secure documents using authenticated encryption.

Restrict access using RBAC, ABAC, and Zero Trust principles.

Maintain complete, tamper-evident audit history.

Track evidence throughout its chain of custody.

Manage police assets from procurement to disposal.

Provide fast full-text and semantic document retrieval.

Preserve document and evidence integrity using cryptographic hashes.

Support digitally signed approvals and verification.

Enable controlled collaboration between authorized departments.

Provide AI-assisted retrieval without bypassing authorization.

Support verifiable cross-organization integrity records.
...
Cases, investigation documents, evidence

Senior Officer

Review, approval, assignment, supervision

Forensic Officer

Evidence examination and forensic reports

Legal Officer

Legal documents, review, court preparation

Auditor

Audit logs, integrity verification, compliance
...
Court/Authorized External User
...
The complete application stack is defined in Section 13.

13. Complete Technology Stack

Mandatory rule: JavaScript only

No TypeScript is used anywhere in CaseVault.

The entire application uses JavaScript.
...
Key Management
  HashiCorp Vault / Cloud KMS / HSM

AI
  Google Gemini API or compatible LLM
...
For the SIH prototype, the recommended implementation subset is:
...
Optional Hyperledger Fabric
        ↓
Optional OCR + OpenSearch + AI/RAG
...
A typical secure operation follows:
...
The system must support a visible verification workflow.
...
"Show the forensic reports related to this case."

"What evidence was transferred to the forensic department?"

"Summarize the investigation timeline."

"Find documents mentioning a specific identifier."
...
All source files use .js or .jsx. No .ts or .tsx files are permitted.
...
Encrypted sensitive fields + hashes
...
SameSite cookies / CSRF controls where applicable
...
git clone https://github.com/<your-org>/casevault.git
cd casevault
